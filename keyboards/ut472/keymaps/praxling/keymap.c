...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	*/
	[3] = LAYOUT(
		KC_ESC, KC_COLN, KC_COMM, KC_EQL, KC_NO, KC_NO, KC_PMNS, KC_7, KC_8, KC_9, KC_PSLS, KC_BSPC, 
		KC_TRNS, KC_LSFT, KC_LCTL, KC_LALT, KC_LGUI, KC_NO, KC_PPLS, KC_4, KC_5, KC_6, KC_PAST, _______, 
		KC_TRNS, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_PDOT, KC_1, KC_2, KC_3, KC_PEQL, KC_SFTENT, 
		KC_TRNS, RGB_TOG, RGB_RMOD, RGB_MOD, KC_TRNS, KC_TRNS, KC_0, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
  ...
  */
  [4] = LAYOUT(
    ...
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, RESET, CG_TOGG, KC_NO, KC_NO, KC_NO, KC_ENT, 
